        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">LuxuryHomes</span>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Your trusted partner in luxury real estate. We specialize in premium properties 
              in Mumbai's most prestigious locations, offering unmatched quality and service.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">+91 93257 80522</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">info@luxuryhomes.com</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} LuxuryHomes. All rights reserved.
            </p>
